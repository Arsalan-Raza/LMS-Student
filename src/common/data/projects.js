...
const projects = [
  {
    id: 0,
    img: "img1",
    name: "TeachOverflow Dashboard UI",
    ...
    files: [
      { name: "TeachOverflow Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "TeachOverflow Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "TeachOverflow Logo.Zip", size: "2.02 MB", link: "#" },
      { name: "TeachOverflow admin.Zip", size: "2.25 MB", link: "#" },
    ],
    comments: [
      {
        id: 1,
