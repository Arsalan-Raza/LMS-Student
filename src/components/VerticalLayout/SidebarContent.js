      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            {/* dropDown  for My classes */}
            <li>
              <Link to="/#" className="waves-effect ps-2">
                <i className="fs-4 ps-2 ion ion-ios-book" />
                <span>My Classes</span>
              </Link>
            </li>
            {/* <ul className="sub-menu" aria-expanded="false"> */}

            <li className="waves-effect ps-4">
              {option.map(option => (
                <Link to="/">
                  <span>{option}</span>
                </Link>
            ...
            {/* <li className="ps-4">
              <Link to="/">{props.t("C++")} </Link>
            </li>
            <li className="ps-4">
              <Link to="/">{props.t("CMS")} </Link>
            </li>
            <li className="ps-4">
              <Link to="/">{props.t("Full Stack")} </Link>
            </li>
            <li className="ps-4">
              <Link to="/">{props.t("React")} </Link>
            </li>
            <li className="ps-4">
              <Link to="/">{props.t("All Classes")} </Link>
            </li> */}
            {/* </ul> */}
